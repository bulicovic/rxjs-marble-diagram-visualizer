        ...
        <div className="max-w-4xl mx-auto px-4">
          <div className="flex flex-col mb-5">
            <div className="flex items-baseline gap-3 flex-wrap">
              <h1 className="text-text text-xl sm:text-3xl font-bold">RxJS Marble Diagram Visualizer Beta V1.1</h1>
              <span className="text-text-muted text-sm">Updated Feb 22, 2025</span>
            </div>
            <span className="text-text-muted text-sm mt-1">*added Subscriber Boundary line to showcase Stream Emission vs. Output Emission</span>
          </div>
          <a href="https://www.angularspace.com/built-rxjs-visualizer-in-4-hours-with-ai-no-coding/"
             target="_blank"
